...
class DataTransformationConfig:
    DATA_TRANSFORMATION_ARTIFACTS_DIR = os.path.join(
        ARTIFACTS, DATA_TRANSFORMATION_ARTIFACTS_DIR
    )
    TRAIN_TRANSFORMS_FILE_PATH = os.path.join(
        DATA_TRANSFORMATION_ARTIFACTS_DIR, TRAIN_TRANSFORMS_FILE
    )
    TEST_TRANSFORMS_FILE_PATH = os.path.join(
        DATA_TRANSFORMATION_ARTIFACTS_DIR, TEST_TRANSFORMS_FILE
    )
